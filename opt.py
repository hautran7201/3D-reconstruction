...
def config_parser(cmd=None):
    ...
    parser.add_argument('--dataset_name', type=str, default='blender',
                        choices=['blender', 'llff', 'nsvf', 'dtu','tankstemple', 'human', 'test_diffusion'])
    ...
    # Alpha and decomposition options
    ...
    parser.add_argument("--freq_reg_ratio_iteration", type=float, default=1,
    ...
    parser.add_argument("--diffu_reg", action='store_true',
                        help='using diffusion reg')
    parser.add_argument('--patch_regulariser_path', 
                        help="Path to diffusion model to use as 2D patch regulariser")
    parser.add_argument('--patch_sample_downscale_factor', type=int, default=4)
    parser.add_argument('--patch_weight_start', type=float, default=0.2)
    parser.add_argument('--patch_weight_finish', type=float, default=0.2)
    parser.add_argument('--patch_reg_start_step', type=int, default=3000)
    parser.add_argument('--patch_reg_finish_step', type=int, default=8000)
