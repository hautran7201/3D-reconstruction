...
class YourOwnDataset(Dataset):
    def __init__(self, datadir=-1, split='train', downsample=1.0, is_stack=False, N_vis=-1, tqdm=True, N_imgs=0):
    ...
    def read_meta(self):
        ...
        # with open(os.path.join(r'/content/ngp_0005', f"transforms_{self.split}.json"), 'r') as f:
