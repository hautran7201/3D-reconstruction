...
class TensorVMSplit(TensorBase):
    ...
    def compute_densityfeature(self, xyz_sampled, mask):
        ...
        for idx_plane in range(len(self.density_plane)):
            ...
            plane_coef_point_ck = torch.isnan(plane_coef_point).any().item()
            line_coef_point_ck = torch.isnan(line_coef_point).any().item()
            sigma_feature_ck = torch.isnan(sigma_feature).any().item()
            if plane_coef_point_ck or line_coef_point_ck or sigma_feature_ck:
                print()
                print('=============================================')
                print(plane_coef_point)
                print(line_coef_point)
                print(self.density_line[idx_plane])
                print(self.density_line[idx_plane].shape)
                print(idx_plane)
                print(coordinate_line[[idx_plane]])
                print(sigma_feature)
                print('=============================================')
